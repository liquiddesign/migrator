...
class Migrator
{
	...
	public function getColumns(string $tableName, bool $onlyPrimary = false): array
	{
		$select = [
			...
			$this->connection->quoteIdentifier('default') => "IF(this.COLUMN_DEFAULT = 'NULL',NULL,IF(this.COLUMN_DEFAULT = 'current_timestamp()','CURRENT_TIMESTAMP',this.COLUMN_DEFAULT))",
